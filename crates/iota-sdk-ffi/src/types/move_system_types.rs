...
//!
//! Each FFI shim wraps an inner [`iota_move_system_types`] type and exposes
...
use iota_move_system_types::framework::iota::IOTA;
...
fn ascii_to_string(s: &iota_move_system_types::std::ascii::String) -> String {
    String::from_utf8_lossy(&s.bytes).into_owned()
}

fn move_string_to_string(s: &iota_move_system_types::std::string::String) -> String {
    String::from_utf8_lossy(&s.bytes).into_owned()
}

fn url_to_string(u: &iota_move_system_types::framework::url::Url) -> String {
...
pub struct TimelockedStakedIota(
    pub iota_move_system_types::iota_system::timelocked_staking::TimelockedStakedIota,
);
...
impl TimelockedStakedIota {
    ...
    pub fn try_from_object(object: &Object) -> Result<Self> {
        Ok(
            iota_move_system_types::iota_system::timelocked_staking::TimelockedStakedIota::try_from_object(
                &object.0,
            )?
            .into(),
        )
    ...
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(
            iota_move_system_types::iota_system::timelocked_staking::TimelockedStakedIota::try_from_bcs(
                &bytes,
            )?
            .into(),
        )
...
impl CoinMetadata {
    ...
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(
            iota_move_system_types::framework::coin::CoinMetadata::<IOTA>::try_from_bcs(&bytes)?
                .into(),
        )
    }
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct Nft(pub iota_move_system_types::stardust::nft::Nft);

#[uniffi::export]
impl Nft {
    #[uniffi::constructor]
    pub fn try_from_object(object: &Object) -> Result<Self> {
        Ok(iota_move_system_types::stardust::nft::Nft::try_from_object(&object.0)?.into())
    }

    #[uniffi::constructor]
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(iota_move_system_types::stardust::nft::Nft::try_from_bcs(&bytes)?.into())
    }
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct Irc27Metadata(pub iota_move_system_types::stardust::irc27::Irc27Metadata);

#[uniffi::export]
impl Irc27Metadata {
    #[uniffi::constructor]
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(iota_move_system_types::stardust::irc27::Irc27Metadata::try_from_bcs(&bytes)?.into())
    }
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct BasicOutput(pub iota_move_system_types::stardust::basic_output::BasicOutput<IOTA>);
...
impl BasicOutput {
    ...
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(
            iota_move_system_types::stardust::basic_output::BasicOutput::<IOTA>::try_from_bcs(
                &bytes,
            )?
            .into(),
        )
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct NftOutput(pub iota_move_system_types::stardust::nft_output::NftOutput<IOTA>);
...
impl NftOutput {
    ...
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(
            iota_move_system_types::stardust::nft_output::NftOutput::<IOTA>::try_from_bcs(&bytes)?
                .into(),
        )
    }
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct AliasOutput(pub iota_move_system_types::stardust::alias_output::AliasOutput<IOTA>);
...
impl AliasOutput {
    ...
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(
            iota_move_system_types::stardust::alias_output::AliasOutput::<IOTA>::try_from_bcs(
                &bytes,
            )?
            .into(),
        )
...
#[derive(Debug, derive_more::From, uniffi::Object)]
#[uniffi::export(Debug)]
pub struct Alias(pub iota_move_system_types::stardust::alias::Alias);

#[uniffi::export]
impl Alias {
    #[uniffi::constructor]
    pub fn try_from_object(object: &Object) -> Result<Self> {
        Ok(iota_move_system_types::stardust::alias::Alias::try_from_object(&object.0)?.into())
    }

    #[uniffi::constructor]
    pub fn try_from_bcs(bytes: Vec<u8>) -> Result<Self> {
        Ok(iota_move_system_types::stardust::alias::Alias::try_from_bcs(&bytes)?.into())
    }
...
pub struct TimelockUnlockCondition(
    pub iota_move_system_types::stardust::timelock_unlock_condition::TimelockUnlockCondition,
);
...
pub struct ExpirationUnlockCondition(
    pub iota_move_system_types::stardust::expiration_unlock_condition::ExpirationUnlockCondition,
);
...
pub struct StorageDepositReturnUnlockCondition(
    pub  iota_move_system_types::stardust::storage_deposit_return_unlock_condition::StorageDepositReturnUnlockCondition,
);
