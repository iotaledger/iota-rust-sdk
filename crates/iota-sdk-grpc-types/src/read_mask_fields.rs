...
//! [`ReadMask`](crate::field::FieldMask)-like wrapper (e.g. [`ObjectReadMask`])
//! that the masked variant of the client method accepts.
//!
//! At a call site you can hand a single field, a slice, or an owned vec of
//! the matching kind — conversion happens automatically:
//!
//! ```ignore
//! use iota_sdk_grpc_types::read_mask_fields::ObjectField;
//!
//! // Single field — passes directly.
