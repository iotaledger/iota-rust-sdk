...
**NOTE**: After generating files, the tool checks if any generated code changed. If changes are detected, you should commit them to keep the generated code in sync with the proto definitions.

## Output

Generated files are written to `crates/iota-sdk-grpc-types/src/proto/generated/`:

- `iota.grpc.v1.*.rs` - Standard protobuf types
- `iota.grpc.v1.*.field_info.rs` - Field metadata and builders
...
Source proto files: `crates/iota-sdk-grpc-types/proto/iota/grpc/v1/`
