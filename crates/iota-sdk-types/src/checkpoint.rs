...
#[cfg_attr(
    ...
    split_serde(json(tag = "type", rename_all = "snake_case"))
)]
...
pub struct CheckpointSummary {
    ...
    #[cfg_attr(
        feature = "serde",
        split_serde(json(skip_serializing_if = "Vec::is_empty", default))
    )]
    ...
    #[cfg_attr(
        feature = "serde",
        split_serde(
            with = "crate::_serde::ReadableBase64Encoded",
            json(skip_serializing_if = "Vec::is_empty", default)
        )
    )]
