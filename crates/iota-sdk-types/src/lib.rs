...
#[cfg(test)]
mod display_tests {
    /// Compile-time assertion: if any listed type does NOT implement Display,
    /// this module will fail to compile.
    fn _assert_display<T: std::fmt::Display + ?Sized>() {}

    #[allow(unused)]
    fn assert_all_types_implement_display() {
        // --- address ---
        _assert_display::<super::Address>();
        _assert_display::<super::AddressParseError>();

        // --- digest ---
        _assert_display::<super::Digest>();
        _assert_display::<super::DigestParseError>();

        // --- object_id ---
        _assert_display::<super::ObjectId>();

        // --- type_tag ---
        _assert_display::<super::Identifier>();
        _assert_display::<super::IdentifierRef>();
        _assert_display::<super::StructTag>();
        _assert_display::<super::TypeTag>();
        _assert_display::<super::TypeParseError>();

        // --- gas ---
        _assert_display::<super::GasCostSummary>();

        // --- object ---
        _assert_display::<super::ObjectReference>();
        _assert_display::<super::ObjectData>();
        _assert_display::<super::MoveStruct>();
        _assert_display::<super::MovePackage>();
        _assert_display::<super::Object>();
        _assert_display::<super::GenesisObject>();
        _assert_display::<super::Owner>();
        _assert_display::<super::ObjectType>();
        _assert_display::<super::TypeOrigin>();
        _assert_display::<super::UpgradeInfo>();

        // --- checkpoint ---
        _assert_display::<super::CheckpointCommitment>();
        _assert_display::<super::EndOfEpochData>();
        _assert_display::<super::CheckpointSummary>();
        _assert_display::<super::SignedCheckpointSummary>();
        _assert_display::<super::CheckpointContents>();
        _assert_display::<super::CheckpointTransactionInfo>();
        _assert_display::<super::CheckpointData>();
        _assert_display::<super::CheckpointTransaction>();

        // --- effects ---
        _assert_display::<super::TransactionEffects>();
        _assert_display::<super::TransactionEffectsV1>();
        _assert_display::<super::ChangedObject>();
        _assert_display::<super::UnchangedSharedObject>();
        _assert_display::<super::UnchangedSharedKind>();
        _assert_display::<super::ObjectIn>();
        _assert_display::<super::ObjectOut>();
        _assert_display::<super::IdOperation>();

        // --- execution_status ---
        _assert_display::<super::ExecutionStatus>();
        _assert_display::<super::ExecutionError>();
        _assert_display::<super::MoveLocation>();
        _assert_display::<super::CommandArgumentError>();
        _assert_display::<super::TypeArgumentError>();
        _assert_display::<super::PackageUpgradeError>();

        // --- events ---
        _assert_display::<super::TransactionEvents>();
        _assert_display::<super::Event>();
        _assert_display::<super::BalanceChange>();

        // --- validator ---
        _assert_display::<super::ValidatorCommittee>();
        _assert_display::<super::ValidatorCommitteeMember>();
        _assert_display::<super::ValidatorAggregatedSignature>();
        _assert_display::<super::ValidatorSignature>();

        // --- transaction ---
        _assert_display::<super::Transaction>();
        _assert_display::<super::TransactionV1>();
        _assert_display::<super::SignedTransaction>();
        _assert_display::<super::TransactionExpiration>();
        _assert_display::<super::GasPayment>();
        _assert_display::<super::RandomnessStateUpdate>();
        _assert_display::<super::TransactionKind>();
        _assert_display::<super::EndOfEpochTransactionKind>();
        _assert_display::<super::ExecutionTimeObservations>();
        _assert_display::<super::ExecutionTimeObservation>();
        _assert_display::<super::ValidatorExecutionTimeObservation>();
        _assert_display::<super::ExecutionTimeObservationKey>();
        _assert_display::<super::AuthenticatorStateExpire>();
        _assert_display::<super::AuthenticatorStateUpdateV1>();
        _assert_display::<super::ActiveJwk>();
        _assert_display::<super::ConsensusDeterminedVersionAssignments>();
        _assert_display::<super::CancelledTransaction>();
        _assert_display::<super::VersionAssignment>();
        _assert_display::<super::ConsensusCommitPrologueV1>();
        _assert_display::<super::ChangeEpoch>();
        _assert_display::<super::ChangeEpochV2>();
        _assert_display::<super::ChangeEpochV3>();
        _assert_display::<super::ChangeEpochV4>();
        _assert_display::<super::SystemPackage>();
        _assert_display::<super::GenesisTransaction>();
        _assert_display::<super::ProgrammableTransaction>();
        _assert_display::<super::Input>();
        _assert_display::<super::Command>();
        _assert_display::<super::TransferObjects>();
        _assert_display::<super::SplitCoins>();
        _assert_display::<super::MergeCoins>();
        _assert_display::<super::Publish>();
        _assert_display::<super::MakeMoveVector>();
        _assert_display::<super::Upgrade>();
        _assert_display::<super::Argument>();
        _assert_display::<super::MoveCall>();

        // --- crypto: keys & signatures ---
        _assert_display::<super::Ed25519PublicKey>();
        _assert_display::<super::Ed25519Signature>();
        _assert_display::<super::Secp256k1PublicKey>();
        _assert_display::<super::Secp256k1Signature>();
        _assert_display::<super::Secp256r1PublicKey>();
        _assert_display::<super::Secp256r1Signature>();
        _assert_display::<super::Bls12381PublicKey>();
        _assert_display::<super::Bls12381Signature>();
        _assert_display::<super::SimpleSignature>();
        _assert_display::<super::UserSignature>();
        _assert_display::<super::InvalidSignatureScheme>();

        // --- crypto: multisig ---
        _assert_display::<super::MultisigMemberPublicKey>();
        _assert_display::<super::MultisigMember>();
        _assert_display::<super::MultisigCommittee>();
        _assert_display::<super::MultisigAggregatedSignature>();
        _assert_display::<super::MultisigMemberSignature>();

        // --- crypto: intent ---
        _assert_display::<super::Intent>();
        _assert_display::<super::IntentScope>();
        _assert_display::<super::IntentVersion>();
        _assert_display::<super::IntentAppId>();
        _assert_display::<super::HashingIntentScope>();
        _assert_display::<super::IntentMessage<String>>();
        _assert_display::<super::PersonalMessage<'static>>();
        _assert_display::<super::IntentError>();

        // --- crypto: zklogin ---
        _assert_display::<super::ZkLoginAuthenticator>();
        _assert_display::<super::ZkLoginInputs>();
        _assert_display::<super::ZkLoginClaim>();
        _assert_display::<super::ZkLoginProof>();
        _assert_display::<super::CircomG1>();
        _assert_display::<super::CircomG2>();
        _assert_display::<super::ZkLoginPublicIdentifier>();
        _assert_display::<super::Bn254FieldElement>();
        _assert_display::<super::Jwk>();
        _assert_display::<super::JwkId>();

        // --- crypto: passkey ---
        _assert_display::<super::PasskeyAuthenticator>();
        _assert_display::<super::PasskeyPublicKey>();

        // --- crypto: move_authenticator ---
        _assert_display::<super::MoveAuthenticator>();

        // --- move_package ---
        _assert_display::<super::MovePackageData>();
        _assert_display::<super::UpgradePolicy>();

        // --- framework ---
        _assert_display::<super::Coin>();
        _assert_display::<super::framework::CoinFromObjectError>();

        // --- iota_names ---
        _assert_display::<super::iota_names::Name>();
        _assert_display::<super::iota_names::NameFormat>();
        _assert_display::<super::iota_names::config::IotaNamesConfig>();
        _assert_display::<super::iota_names::error::IotaNamesError>();
        _assert_display::<super::iota_names::registry::Table>();
        _assert_display::<super::iota_names::registry::Registry>();
        _assert_display::<super::iota_names::registry::RegistryEntry>();
        _assert_display::<super::iota_names::registry::ReverseRegistryEntry>();
        _assert_display::<super::iota_names::registry::NameRecord>();
        _assert_display::<super::iota_names::NameRegistration>();
        _assert_display::<super::iota_names::SubnameRegistration>();
    }
}
