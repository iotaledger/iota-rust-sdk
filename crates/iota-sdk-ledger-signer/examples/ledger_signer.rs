...
// fn transaction_from_base64(b64: &str) -> Result<TransactionData,
// anyhow::Error> {     let bytes =
...
async fn main() -> Result<()> {
    ...
    //     let network = matches.get_one::<String>("network").map(|s|
    ...
    //     let transaction =
    // transaction_from_base64(matches.get_one::<String>("transaction").
    // unwrap())?;
