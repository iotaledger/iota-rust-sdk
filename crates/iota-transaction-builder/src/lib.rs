...
/// already BCS serialized and is put verbatim into the transaction.
...
/// Convert from an [`unresolved::Input`] to a [`unresolved::ObjectReference`].
/// This is used to convert gas objects into unresolved object references.
