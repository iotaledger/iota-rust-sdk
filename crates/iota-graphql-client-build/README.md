...
```toml
[build-dependencies]
iota-graphql-client-build = { git = "https://github.com/iotaledger/sui-rust-sdk", package = "iota-graphql-client-build", branch = "master" }
```
...
[dependencies]
cynic = "3.8.0"
iota-graphql-client = { git = "https://github.com/iotaledger/sui-rust-sdk", package = "iota-graphql-client", branch = "master" }
