...
use iota_transaction_builder::{SharedMut, TransactionBuilder, result_ref};
...
async fn main() -> Result<()> {
    ...
    builder
        ...
        .arguments([result_ref("name_record_opt")])
        .type_tags([TypeTag::Struct(Box::new(StructTag {
            address: iota_names_package_address,
    ...
    builder
        .move_call(Address::STD_LIB, "option", "borrow")
        .arguments([result_ref("target_address_opt")])
        .generics::<Address>()
        .result_refs("target_address");
