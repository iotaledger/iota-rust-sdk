...
async def main():
    ...
    split_amounts = [
        builder.input(UnresolvedInput.new_pure(amount.to_bytes(8, "little")))
    ...
    for i, recipient in enumerate(recipient_addresses):
        ...
        recipient_arg = builder.input(
            UnresolvedInput.new_pure(Address.from_hex(recipient).to_bytes())
        )
