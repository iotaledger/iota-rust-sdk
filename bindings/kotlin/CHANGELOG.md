...
- *(Kotlin)* Remove _ffi suffix from lib file (#489)
...
- *(kotlin)* Add Android support to Kotlin bindings (#972)
...
- Give the kotlin Gradle build enough JVM heap (#1412)
...
## [0.0.1-alpha.4] - 2025-12-05

Testing release workflow

## [0.0.1-alpha.3] - 2025-11-18
