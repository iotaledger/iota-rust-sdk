...
suspend fun main() {
    ...
    println("   - Emitted by Move functions")
    println("   - Track on-chain activities")
    println("   - Essential for reactive apps")
    println("   - Filterable and queryable\n")
    ...
    println("See also: PackageEvents.kt, GetTransaction.kt")
}
